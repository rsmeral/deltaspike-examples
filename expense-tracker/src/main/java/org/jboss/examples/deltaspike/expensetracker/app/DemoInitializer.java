...
public class DemoInitializer {
    ...
    public void initialize() {
        if (!initialized) {
             ...
             * IdentityManager.
             */
//        ctxCtl.startContext(WindowScoped.class);
//        ctxCtl.startContext(RequestScoped.class);
//        ctxCtl.startContext(GroupedConversationScoped.class);
...
//        ctxCtl.stopContext(GroupedConversationScoped.class);
//        ctxCtl.stopContext(RequestScoped.class);
//        ctxCtl.stopContext(WindowScoped.class);
            initialized = true;
        }
    }
